--------------------------------------------------------------------
- BEGIN OF /var/www/localhost/htdocs/PHP_Beautifier/Beautifier.php -
--------------------------------------------------------------------
    ...
    class PHP_Beautifier implements PHP_Beautifier_Interface {
        ...
        */
        public function __construct() {
            ...
            if (false) { // debug to file. Set to true to log
                @unlink('log.txt');
                $oLogFile = Log::factory('file', 'log.txt', 'php_beautifier', array() , PEAR_LOG_DEBUG);
...
?>
--------------------------------------------------------------------
- END OF /var/www/localhost/htdocs/PHP_Beautifier/Beautifier.php   -
--------------------------------------------------------------------

--------------------------------------------------------------
- BEGIN OF /var/www/localhost/htdocs/PHP_Beautifier/demo.php -
--------------------------------------------------------------

<HTML>

--------------------------------------------------------------
- END OF /var/www/localhost/htdocs/PHP_Beautifier/demo.php   -
--------------------------------------------------------------

--------------------------------------------------------------
- BEGIN OF /var/www/localhost/htdocs/PHP_Beautifier/test.php -
--------------------------------------------------------------
...
<?php
    ...
    PHP_Beautifier_Common::getFilesByGlob('/var/www/localhost/htdocs/PHP_Beautifier/*.php', true);
    try {
        ...
        $oBatch->setInputFile('./examples/*.php');
...
?>
--------------------------------------------------------------
- END OF /var/www/localhost/htdocs/PHP_Beautifier/test.php   -
--------------------------------------------------------------

---------------------------------------------------------------
- BEGIN OF /var/www/localhost/htdocs/PHP_Beautifier/test2.php -
---------------------------------------------------------------
...
EOS;
     ?>
---------------------------------------------------------------
- END OF /var/www/localhost/htdocs/PHP_Beautifier/test2.php   -
---------------------------------------------------------------
